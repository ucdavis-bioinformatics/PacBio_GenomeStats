...
## Loading Table
t_prod <- data.frame("ZMWs"=table(polymerase_reads$ZmwType,polymerase_reads$ProductivityLabel)[,c("Empty","Productive","Other")])
...
```{r echo=FALSE}
### NO NEED TO READ IN SEQUENCE DATA?
# fa1 <- readDNAStringSet(dir(file.path(basedir,run,cell,"Analysis_Results"),pattern="1.subreads.fasta"",full.names=TRUE)
# fa2 <- readDNAStringSet(dir(file.path(basedir,run,cell,"Analysis_Results"),pattern="2.subreads.fasta"",full.names=TRUE)
# fa3 <- readDNAStringSet(dir(file.path(basedir,run,cell,"Analysis_Results"),pattern="3.subreads.fasta"",full.names=TRUE)
#
# fa <- c(fa1,fa2,fa3)
#
